...
<nav class="nb navbar-default navbar-fixed-top">
        <div class="container-fluid nb">
            <div class="navbar-header"><a class="nav navbar-brand navbar-link" href="<?php echo base_url('homepage') ?>"><img src="<?php echo base_url('assets/img/estulogo.png') ?>" alt="Avatar" width="100" height="30"> </a>
